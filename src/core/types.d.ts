...
export type RoleId = "COMMANDING_OFFICER" | "MARINE_ENGINEERING_OFFICER" | "WEAPON_ELECTRICAL_OFFICER" | "FLEET_SUPPORT_GROUP" | "LOGISTICS_COMMAND" | "SYSTEM";
...
export type AttentionSignal = "STALE" | "BLOCKED_BY_REJECTION" | "PENDING_TOO_LONG";
export type TaskHistoryType = "CREATED" | "CHECKED" | "STATUS_CHANGED" | "REPLANNED" | "NOTIFIED" | "COMPLETED" | "ESCALATED";
export type ApprovalHistoryType = "CREATED" | "SUBMITTED" | "APPROVED" | "REJECTED" | "INVALID_ATTEMPT" | "STALE_REMINDER_SENT";
...
export interface RuleDecision {
    ...
    businessDate: string;
    result: "COMPLIANT" | "NON_COMPLIANT" | "ESCALATE" | "NO_CHANGE" | "TASK_CREATED" | "TASK_COMPLETED" | "TASK_OVERDUE" | "TASK_ESCALATED" | "RECORD_CREATED" | "RECORD_SUBMITTED" | "RECORD_APPROVED" | "RECORD_REJECTED" | "RECORD_NOTIFIED";
    missingLogs: LogType[];
...
export declare const REQUIRED_DAILY_LOGS: LogType[];
